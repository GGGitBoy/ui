...
export default Service.extend({
  ...
  login(providerId, body, captcha) {
    ...
    let req = this.get('globalStore').rawRequest({
      ...
      if ( data.body !== null && data.body.enabledMfa) {
        var me = {}
      ...
      console.log(res)
      err.loginCooldown = res && res.headers && res.headers.map['x-pandaria-login-cooldown'];
      console.log(err.loginCooldown)
